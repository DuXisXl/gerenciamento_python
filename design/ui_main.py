...
"")
        ...
        self.btn_insert_produto = QPushButton(self.frame_2)
        self.btn_insert_produto.setObjectName(u"btn_insert_produto")
        self.btn_insert_produto.setMinimumSize(QSize(100, 27))
        self.btn_insert_produto.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_insert_produto.setStyleSheet(u"QPushButton{\n"
"	color: rgb(0,0,10);\n"
"    border-radius: 10px;\n"
"	 font-size: 16px; \n"
"	background-color: #fff;\n"
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.btn_insert_produto)
...
"")
        ...
        self.label_36 = QLabel(self.pg_cadastro_produto)
        self.label_36.setObjectName(u"label_36")
        self.label_36.setGeometry(QRect(9, 65, 819, 54))
        self.label_36.setFont(font2)
        self.label_36.setAlignment(Qt.AlignCenter)
        self.label_40 = QLabel(self.pg_cadastro_produto)
        self.label_40.setObjectName(u"label_40")
        self.label_40.setGeometry(QRect(9, 9, 819, 50))
        self.label_40.setFont(font)
        self.label_40.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.label_40.setAlignment(Qt.AlignCenter)
        self.layoutWidget = QWidget(self.pg_cadastro_produto)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(300, 390, 241, 51))
        ...
        self.btn_cadastrar_produto = QPushButton(self.layoutWidget)
        self.btn_cadastrar_produto.setObjectName(u"btn_cadastrar_produto")
        self.btn_cadastrar_produto.setMinimumSize(QSize(0, 35))
...
"")
        ...
        self.horizontalLayout_18.addWidget(self.btn_cadastrar_produto)
        ...
        self.layoutWidget_2 = QWidget(self.pg_cadastro_produto)
        self.layoutWidget_2.setObjectName(u"layoutWidget_2")
        self.layoutWidget_2.setGeometry(QRect(240, 120, 296, 30))
        ...
        self.nome_produto = QLineEdit(self.layoutWidget_2)
        self.nome_produto.setObjectName(u"nome_produto")
        self.nome_produto.setStyleSheet(u"color:rgba(211, 239, 251,1);\n"
"border-bottom:1px solid white;\n"
"border-radius: None;\n"
"background-color:rgba(85, 115, 155,0.1);\n"
"font-family:Trebuchet MS; \n"
"font-size:21px;")
        self.nome_produto.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout_19.addWidget(self.nome_produto)

        self.layoutWidget_3 = QWidget(self.pg_cadastro_produto)
        self.layoutWidget_3.setObjectName(u"layoutWidget_3")
        self.layoutWidget_3.setGeometry(QRect(240, 150, 296, 30))
        self.horizontalLayout_20 = QHBoxLayout(self.layoutWidget_3)
        self.horizontalLayout_20.setObjectName(u"horizontalLayout_20")
        self.horizontalLayout_20.setContentsMargins(50, 0, 0, 0)
        self.label_37 = QLabel(self.layoutWidget_3)
        self.label_37.setObjectName(u"label_37")

        self.horizontalLayout_20.addWidget(self.label_37)

        self.descricao_produto = QLineEdit(self.layoutWidget_3)
        self.descricao_produto.setObjectName(u"descricao_produto")
        self.descricao_produto.setStyleSheet(u"color:rgba(211, 239, 251,1);\n"
"border-bottom:1px solid white;\n"
"border-radius: None;\n"
"background-color:rgba(85, 115, 155,0.1);\n"
"font-family:Trebuchet MS; \n"
"font-size:21px;")
        self.descricao_produto.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout_20.addWidget(self.descricao_produto)

        self.layoutWidget_4 = QWidget(self.pg_cadastro_produto)
        self.layoutWidget_4.setObjectName(u"layoutWidget_4")
        self.layoutWidget_4.setGeometry(QRect(240, 180, 296, 30))
        self.horizontalLayout_21 = QHBoxLayout(self.layoutWidget_4)
        self.horizontalLayout_21.setObjectName(u"horizontalLayout_21")
        self.horizontalLayout_21.setContentsMargins(50, 0, 0, 0)
        self.label_38 = QLabel(self.layoutWidget_4)
        self.label_38.setObjectName(u"label_38")

        self.horizontalLayout_21.addWidget(self.label_38)

        self.quantidade = QLineEdit(self.layoutWidget_4)
        self.quantidade.setObjectName(u"quantidade")
        self.quantidade.setStyleSheet(u"color:rgba(211, 239, 251,1);\n"
"border-bottom:1px solid white;\n"
"border-radius: None;\n"
"background-color:rgba(85, 115, 155,0.1);\n"
"font-family:Trebuchet MS; \n"
"font-size:21px;")
        self.quantidade.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout_21.addWidget(self.quantidade)

        self.layoutWidget_5 = QWidget(self.pg_cadastro_produto)
        self.layoutWidget_5.setObjectName(u"layoutWidget_5")
        self.layoutWidget_5.setGeometry(QRect(240, 210, 296, 30))
        self.horizontalLayout_22 = QHBoxLayout(self.layoutWidget_5)
        self.horizontalLayout_22.setObjectName(u"horizontalLayout_22")
        self.horizontalLayout_22.setContentsMargins(50, 0, 0, 0)
        self.label_39 = QLabel(self.layoutWidget_5)
        self.label_39.setObjectName(u"label_39")

        self.horizontalLayout_22.addWidget(self.label_39)

        self.valor_produto = QLineEdit(self.layoutWidget_5)
        self.valor_produto.setObjectName(u"valor_produto")
        self.valor_produto.setStyleSheet(u"color:rgba(211, 239, 251,1);\n"
"border-bottom:1px solid white;\n"
"border-radius: None;\n"
"background-color:rgba(85, 115, 155,0.1);\n"
"font-family:Trebuchet MS; \n"
"font-size:21px;")
        self.valor_produto.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout_22.addWidget(self.valor_produto)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtreewidgetitem.setText(4, QCoreApplication.translate("MainWindow", u"Pre\u00e7o", None));
        ___qtreewidgetitem.setText(3, QCoreApplication.translate("MainWindow", u"Quantidade", None));
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("MainWindow", u"Descri\u00e7\u00e3o Produto", None));
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("MainWindow", u"Nome Produto", None));
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("MainWindow", u"ID Produto", None));
        ...
        ___qtreewidgetitem1.setText(2, QCoreApplication.translate("MainWindow", u"Quantidade de vendas", None));
        ___qtreewidgetitem1.setText(1, QCoreApplication.translate("MainWindow", u"Nome Produto", None));
        ___qtreewidgetitem1.setText(0, QCoreApplication.translate("MainWindow", u"ID Produto", None));
        ...
        self.btn_insert_produto.setText(QCoreApplication.translate("MainWindow", u"Adicionar Produto", None))
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; color:#ffffff;\">Desenvolvedor: Eduardo Ramos Pereira</span></p></body></html>", None))
        ...
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#ffffff;\">(11)91280-7450</span></p></body></html>", None))
        ...
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#ffffff;\">eduardoramos245r@gmail.com</span></p></body></html>", None))
        ...
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#ffffff;\">Dev Duxis</span></p></body></html>", None))
        self.label_32.setText("")
        self.label_36.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><img src=\"_imgs/user.png\"/></p><p align=\"center\"><span style=\" font-size:14pt; font-weight:600; color:#ffffff;\">CADASTRAR PRODUTO</span></p></body></html>", None))
        self.label_40.setText(QCoreApplication.translate("MainWindow", u"Tela de cadastro", None))
        self.label_33.setText("")
        self.btn_cadastrar_produto.setText(QCoreApplication.translate("MainWindow", u"Cadastrar", None))
        self.label_34.setText("")
        self.label_35.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#ffffff;\">Nome do Produto:</span></p></body></html>", None))
        self.label_37.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#ffffff;\">Descri\u00e7\u00e3o do Produto:</span></p></body></html>", None))
        self.label_38.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#ffffff;\">Quantidade:</span></p></body></html>", None))
        self.label_39.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#ffffff;\">Valor:</span></p></body></html>", None))
